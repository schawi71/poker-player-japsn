...
public class Player {
    ...
    public static void main (String[] args)
    {
    	...
    	for (Iterator<JsonElement> itr = playersList.iterator() ; itr.hasNext ();) {
    		...
    		JsonObject player = elemnt.getAsJsonObject();
